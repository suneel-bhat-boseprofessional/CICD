...
:: Load the binary
::"%CUBEPROGRAMMER_TOOL_PATH%\STM32_Programmer_CLI.exe" -c port=SWD mode=HOTPLUG AP=1 -el "%CUBEPROGRAMMER_TOOL_PATH%\ExternalLoader\touchUI_ExtMemLoader_144.stldr" -d "%BIN_DIR%touchUI_BringUP_Appli_assets.hex"
"%CUBEPROGRAMMER_TOOL_PATH%\STM32_Programmer_CLI.exe" -c port=SWD mode=HOTPLUG AP=1 -el "%CUBEPROGRAMMER_TOOL_PATH%\ExternalLoader\touchUI_BringUP_ExtMemLoader.stldr" -d "%BIN_DIR%touchUI_BringUP_Appli_assets.hex"
